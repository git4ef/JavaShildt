...
public class InstanceMethWithObjectRefDemo {
    static <T> int counter(T[] vals, MyFuncForInstMeth<T> f, T v) {
        int count = 0;
    ...
    public static void runInstanceMethWithObjRef() {
        int count;
        ...
        System.out.println("Дней, когда макс. температура была 89: " + count);
